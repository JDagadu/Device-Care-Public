...
export default function buildSuccessDialog(){
    document.body.append(elt('div',{id:'success-modal',className:'fixed inset-0 z-50 bg-gray-600  bg-opacity-50 overflow-y-auto h-full w-full'},
    elt('div',{className:'relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white'},
        elt('div',{className:'mt-3 text-center'},
            ...
            elt('h3',{className:'text-lg leading-6 font-medium text-gray-900'},'Successfully!'),
            elt('div',{className:'mt-2 px-7 py-3'},
                elt('p',{className:'text-sm text-gray-500'},'Insert success message here!')),
